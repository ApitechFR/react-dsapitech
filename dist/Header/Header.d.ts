...
export declare const Header: React.MemoExoticComponent<
    React.ForwardRefExoticComponent<HeaderProps & React.RefAttributes<HTMLDivElement>>
>;
export default Header;
export declare const useTranslation: () => {
        t: (<K extends "menu" | "close">(
            messageKey: K
        ) => {
            menu: string;
            close: string;
        }[K] extends (params: any) => infer R
            ? R
            : {
                  menu: string;
                  close: string;
            ...
            (<K_1 extends never>(
                ...
                menu: string;
                close: string;
            }[K_1] extends (params: any) => infer R_1
                ? R_1
                : {
                      menu: string;
                      close: string;
