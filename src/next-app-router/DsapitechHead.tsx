...
import AppleTouchIcon from "@apitech/react-dsapitech/dsapitech/favicon/apple-touch-icon.png";
import FaviconSvg from "@apitech/react-dsapitech/dsapitech/favicon/favicon.svg";
import FaviconIco from "@apitech/react-dsapitech/dsapitech/favicon/favicon.ico";
...
import "@apitech/react-dsapitech/assets/dsapitech_plus_icons.scss";
// eslint-disable-next-line @typescript-eslint/no-unused-vars -- used in doc

export type DsapitechHeadProps = {
     ...
     *
     * Don't forget to add `doCheckNonce: true` in {@link startReactDsapitech} options.
     *
     ...
     *
     * Don't forget to add `trustedTypesPolicyName` in {@link startReactDsapitech} options.
     *
...
export function DsapitechHeadBase(
    props: DsapitechHeadProps & {
        Link: Function;
    }
) {
    const {
