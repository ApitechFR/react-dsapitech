...
import marianneFaviconSvgUrl from "./dsapitech/favicon/favicon.svg";
import blankFaviconSvgUrl from "./assets/blank-favicon.svg";

export function getMuiDsapitechThemeOptions(params: {
    isDark: boolean;
        ...
        "components": {
            ...
            "MuiTablePagination": {
                "styleOverrides": {
                    ...
                    "selectLabel": {
                        //Fixes: https://github.com/ApitechFR/react-dsapitech/assets/6702424/678a7f69-d4e8-4897-85f0-65c605b46900
                        "margin": "unset"
                    }
                }
            },
 ...
 */
export function createMuiDsapitechTheme(
    params: { isDark: boolean; breakpointsValues: BreakpointsValues },
    ...args: object[]
): mui.Theme {
    const muiTheme = mui.createTheme(getMuiDsapitechThemeOptions(params), ...args);

    return muiTheme;
}

export function createMuiDsapitechThemeProvider(params: {
    ...
    function MuiDsapitechThemeProvider(props: Props) {
        ...
        const theme = useMemo(() => {
            const nonAugmentedMuiTheme = createMuiDsapitechTheme({ isDark, breakpointsValues });
    ...
    return { MuiDsapitechThemeProvider };
}

export const { MuiDsapitechThemeProvider } = createMuiDsapitechThemeProvider({});

export default MuiDsapitechThemeProvider;

export function createDsapitechCustomBrandingProvider(params: {
    ...
    function useMuiTheme() {
        ...
        const { theme, isGov, faviconUrl_userProvided } = useMemo(() => {
            const theme_gov = createMuiDsapitechTheme({ isDark, breakpointsValues });
    ...
    function DsapitechCustomBrandingProvider(props: { children: ReactNode }) {
        const { children } = props;
    ...
    return { DsapitechCustomBrandingProvider };
}
